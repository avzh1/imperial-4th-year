...
Here, we have an example sentence in french ``Le chat est sur le tapis'' with references (shown on the example) and two outputs, \texttt{MT\_Bad} and \texttt{MT\_Ok}.
